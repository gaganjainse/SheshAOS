...
![Code of Conduct](https://img.shields.io/badge/Code%20of%20Conduct-Contributor%20Covenant%20v2.1-blue?style=for-the-badge)
...
```mermaid
graph TD
    A["Report Received"] --> B{"Valid Report?"}
    B -->|No| C["Close with Explanation"]
    B -->|Yes| D{"Severity Level"}
    
    D -->|Minor| E["Correction"]
    D -->|Moderate| F["Warning"]
    D -->|Serious| G["Temporary Ban"]
    D -->|Severe| H["Permanent Ban"]
    
    E --> I["Document Outcome"]
    F --> I
    G --> I
    H --> I
...
<p align="center">
  <b>🤗 We are committed to making NexusAOS a welcoming community for everyone</b>
</p>
