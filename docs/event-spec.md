# NexusAOS Event Specification

## Overview

Events are the source of truth in NexusAOS. Every state change, model interaction,
...
| SystemStarted | NexusAOS started |
| SystemShutdown | NexusAOS shut down |
