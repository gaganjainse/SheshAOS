    ...
    pub fn new(id: usize, kind: BlockKind) -> Self {
        let initial_content = match kind {
            BlockKind::PtyTerminal => vec![
                ...
                "$ echo 'SheshAOS Wave Engine Running'".to_string(),
            ],
            ...
            BlockKind::CodeEditor => vec![
                "// File: /home/gagan/Workspace/SheshAOS/crates/shesh-kernel/src/lib.rs"
                    .to_string(),
                "1 | pub mod kernel;".to_string(),
                "2 | pub mod policy;".to_string(),
                "3 | pub mod storage;".to_string(),
                "4 | pub fn init() { println!(\"SheshAOS Kernel Online\"); }".to_string(),
            ],
            ...
            BlockKind::AiFileDiff => vec![
                "--- a/crates/shesh-tui/src/app.rs".to_string(),
                "+++ b/crates/shesh-tui/src/app.rs".to_string(),
                "@@ -10,3 +10,4 @@".to_string(),
            ...
            BlockKind::ProcessViewer => vec![
                ...
                "1042  gagan   0.0    0.1    shesh (Native Wave Engine)".to_string(),
