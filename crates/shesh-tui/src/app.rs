...
use shesh_blockctl::controller::ControllerRegistry;
use shesh_waveobj::store::WaveStore;
use shesh_wps::broker::Broker;
use shesh_wps::events::SubscriptionRequest;
use shesh_wps::events::{EVENT_BLOCK_UPDATE, EVENT_CONFIG};
use std::sync::Arc;
use uuid::Uuid;
    ...
    pub fn new(
        ...
        Self {
            ...
            history: vec![
                ...
                "Loaded Project: /home/gagan/Workspace/SheshAOS".to_string(),
            ...
            project_tree: vec![
                "▼ SheshAOS [Workspace]".to_string(),
                "  ▶ bin/shesh-cli/".to_string(),
                "  ▼ crates/".to_string(),
                "    ▶ shesh-kernel/".to_string(),
                "    ▶ shesh-vault/".to_string(),
                "    ▶ shesh-tui/".to_string(),
                "    ▶ shesh-terminal/".to_string(),
                "  ▶ configs/default.toml".to_string(),
                "  📄 Cargo.toml".to_string(),
                "  📄 README.md".to_string(),
            ],
            git_branch: "main*".to_string(),
            run_config: "shesh [Debug]".to_string(),
            current_file: "crates/shesh-kernel/src/lib.rs".to_string(),
            ram_used_mb: 7420,
            ram_total_mb: 16000,
            vram_used_mb: 1536,
            vram_total_mb: 6144,
