...
use shesh_ai::openai::OpenAIProvider;
use shesh_ai::session::{ChatSession, StreamHandle};
...
impl NexusApp {
            ...
            NexusApp {
                ...
                ai_messages: vec![
                    ChatMessage {
                        ...
                        content: "Welcome to SheshAOS AI!".to_string(),
                        is_streaming: false,
                    },
                    ChatMessage {
                        role: "assistant".to_string(),
    ...
    pub fn title(&self) -> String {
        format!("SheshAOS — {}", self.terminal.title())
    }
